...
std::vector<int> MeshRefTetrahedra(const int P) {
  ...
  case 1:
    return {0, 1, 2, 3};
  case 2:
    return {8, 6, 4, 2, 7, 5, 4, 3, 9, 5, 6, 1, 9, 8, 4, 0, 9, 5, 6, 4, 9, 8, 6, 4, 9, 7, 5, 4, 9, 7, 4, 0};
  case 3:
    return {0, 7, 5, 7, 8, 9, 8, 1, 3, 9, 5, 7, 3, 9,
            8, 5, 9, 6, 9, 3, 4, 4, 6, 9, 6, 4, 2};
  case 4:
...
int main(int argc, char **argv) {
  ...
  PetscInitialize(&argc, &argv, nullptr, nullptr);
  {
    ...
    std::string mesh_filepath =
        "/home/sr2120/rendering/ascent_dolfinx/spherical_2d/mesh.xdmf";
    ...
    basix::FiniteElement element = basix::create_element<T>(
        basix::element::family::P, basix::cell::type::triangle,
    ...
    std::vector facets = mesh::locate_entities_boundary(*mesh_p, 1, [](auto x) {
